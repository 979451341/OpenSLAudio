...
void Java_com_ywl5320_openslaudio_MainActivity_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_ywl5320_openslaudio_MainActivity_createBufferQueueAudioPlayer(JNIEnv* env,
                                                                           jclass clazz)
{
    SLresult result;
...
jboolean Java_com_ywl5320_openslaudio_MainActivity_createAssetAudioPlayer(JNIEnv* env, jclass clazz,
...
void Java_com_ywl5320_openslaudio_MainActivity_setPlayingAssetAudioPlayer(JNIEnv* env,
...
void Java_com_ywl5320_openslaudio_MainActivity_setStop(JNIEnv* env,
                                                                          jclass clazz)
{
    SLresult result;
